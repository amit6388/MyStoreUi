      ...
      <div className='container-fluid a' style={{ background: '#e0f7fa', minHeight: "500px" }}>
        ...
        <div className='row'>
          ...
          <div className='col-sm-10 mt-5'>
            <h2><u style={{ color: '#00796b' }}>Recient Added</u> Product</h2>
            {data.length === 0 ? (
              ...
              <div className='row'>
                {data?.slice(0, 4)?.map((item) => (
                  <div className='col-sm-3 mb-4' key={item._id}>
                    <div className="card shadow-sm" style={{ width: '100%', border: 'none', textAlign: "left", borderRadius: '10px', position: 'relative' }}>
                      <img
